...
//			System.out.println("*****************************");
		...
		respuestasRadioDAO.registrarRespuestas(radioRespuestas, idRegistroFormulario);
		
		//Cargo respuestas texto
		RespuestasCheckDAOImpl respuestasCheckDAO = new RespuestasCheckDAOImpl();
		respuestasCheckDAO.registrarRespuestas(checkRespuestas, idRegistroFormulario);
